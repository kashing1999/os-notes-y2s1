...
- A process amy be in one of two states:
  - running
  - not-running
...
- Gives preferential treatment to important jobs
  ...
  - Are not interrupted until CPU cycles are completed or a natural wait occurs
