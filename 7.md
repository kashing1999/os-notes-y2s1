...
- Disadvantages:
  ...
  - Trace data may be difficult to colelct and require large amounts of data

## Threads
- A process is divided into a number of light weight processes
- A thread is smalelr than a process
...
- Advantages:
  ...
  - If on thread in a process is blocked, the kernel schedule another thread of the same process
- Disadvantages:
