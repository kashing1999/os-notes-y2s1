...
|Turn == process|Interested[1]|Status|
|:-:|:-:|:-:|
|F|F|Continue|
|F|T|Continue|
|T|F|Continue|
...
- Entrance to the critical section is granted for process 1 if process 2 does not want to enter its critical section or if process 2 has given priority to process 1 by setting turn to 1
- Properties:
  - Mutual Exclusion
  - Absence of deadlock
...
## Semaphore
- A variable that has a nonnegative integer which obey these rules:
...
- Most well-known semaphores are signalling devices used by railroads to indicate if a section of track is clear ![example-of-semaphore](./img/example-of-semaphore.png) <i><p style="text-align: center;">Figure: Example of Semaphore</p></i>
