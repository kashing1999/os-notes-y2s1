...
- Physical characteristics of most secondary memory devices favor larger page size for more efficinet block transfer of data
...
- VMs are implemented through demand paging and segmentation schemes:
...
- Allows a program to be loaded multiple times and occupy different emmory location each time
...
- Can be shared among processes
  - Dynamic libraries
  - Sharing segments can incur less overhead than sharing
