...
<br>
However, the first generation Microkernels were inefficient and slow due to overheads from passing information between applications and servers
...
## Time Sharing
- Using multiprogramming to handle multiple interactive jons
